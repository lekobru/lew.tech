...
#define CLASSNAME BasePlayer
	...
	{
	public:
		NETVAR(float, DT_CSPlayer, m_flDuckJumpTime);
		...
		NETVAR(int, DT_BasePlayer, m_nWaterLevel);
		...
		*/
		...
		inline C_AnimationLayer& GetAnimOverlay(int index)
		{
			typedef C_AnimationLayer(__thiscall* GetAnimOverlay_t)(void*, int);
			return ((GetAnimOverlay_t)((DWORD)0x2403D7C0))(this, index);
		}

		inline int GetSequenceActivity(int sequence)
		{
			typedef int(__thiscall* GetSequenceActivity_t)(void*, int);
			return ((GetSequenceActivity_t)(((DWORD)0x240341F0)))(this, sequence);
		}

		inline float GetCurrentTorsoYaw()
		{
			typedef float(__thiscall* GetCurrentTorsoYaw_t)(void*);
			return ((GetCurrentTorsoYaw_t)(((DWORD)this + 0xA6E0)))(this);
		}
		...
		inline unsigned short& m_EntClientFlags()
		{
			return *(unsigned short*)((DWORD)this + 0x52 + 0x4);
		}
